...
export const StudentHome: React.FC<StudentHomeProps> = ({
  ...
  return (
    <div className="space-y-6 sm:space-y-8 animate-in fade-in duration-300">
          ...
          <div className="bg-stone-50 rounded-xl p-4 border border-stone-200 min-w-[280px]">
            ...
            <div className="mt-2.5 flex items-start justify-between gap-2">
              <p className="text-xs text-stone-600 leading-relaxed">
                Complete your GitHub/project information to improve your profile.
              </p>
              <button
                onClick={() => setShowGithubModal(true)}
                className="shrink-0 text-xs text-amber-700 font-bold hover:underline flex items-center gap-1"
      ...
      {/* 2. Notification Banner: "🔔 New for you" */}
                  ...
                  <div className="mt-3.5 pt-3 border-t border-stone-100 flex flex-wrap items-center justify-between gap-2">
                    <div className="flex flex-wrap items-center gap-1.5">
                      ...
                      {opp.matchedSkills.map((s) => (
                        <span
                          key={s}
                          className="text-[11px] font-medium px-2 py-0.5 bg-emerald-50 text-emerald-800 border border-emerald-200 rounded-md"
                        >
                          ✓ {s}
                        </span>
                      ))}
                ...
                {activeOpp.missingSkills.map((missingSkill) => {
                  ...
                  return (
                    <div
                      ...
                      className="bg-white p-3 rounded-xl border border-amber-200 flex items-start gap-3 cursor-pointer hover:bg-amber-50/40 transition-colors"
                    >
                      <input
                        type="checkbox"
                        checked={!!isDone}
                      ...
                      <div className="flex-1">
                        <div className="flex items-center justify-between">
                          ...
                          >
                            Build a mini-project demonstrating {missingSkill}
                          </span>
                        ...
                        <p className="text-[11px] text-stone-500 mt-0.5">
                          Push a standalone repository or link an API endpoint with {missingSkill} to your profile.
                        </p>
                      </div>
                    </div>
                  );
